...
class UnpackServer():
    ...
    def __init__(self):
        ...
        # не лучшие практики хранение жестко зашитых данных в ините, тем более путей
        ...
        for file in files:
            ...
            if 'name' in file:
                filepath = self._normalize_filepath(
                    file['name'], extension=file['type'] if 'type' in file else None)
            else:
...
answer=v.get_common_file({'code': 'main', 'file': [
                         {'code': '3456dcgbyt', 'name': '45.00.679.0.', 'type': '.svg'}]})
